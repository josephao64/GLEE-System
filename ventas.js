...
// Inicializar Firebase (si aún no se ha inicializado; si ya lo haces en otro módulo, omite esta parte)
if (!firebase.apps.length) {
  ...
  /* Finalizar venta: abre modal para solicitar datos adicionales */
  ...
  async function showSalesHistory() {
    try {
      ...
      snapshot.forEach(doc => {
        ...
        // Se muestra el precio unitario del primer producto como referencia
